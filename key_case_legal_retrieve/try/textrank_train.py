...
def main():
    ...
    parser.add_argument('-train_file', default='data/textrank_filter/filter_train.json', type=str)
    parser.add_argument('-dev_file', default='data/textrank_filter/filter_dev.json', type=str)
    ...
    parser.add_argument('-report_step', default=17000, type=int)
...
class LongDataset(Dataset):
    def __init__(self, data_file):
        self.tokenizer = AutoTokenizer.from_pretrained("../pretrained_model/roberta")
    ...
    def __getitem__(self, index):
        ...
        query_cut = self.tokenizer.tokenize(data['query'])[:300]
        candidate_cut = self.tokenizer.tokenize(data['candidate'])[:1600]

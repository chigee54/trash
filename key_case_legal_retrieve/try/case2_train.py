...
def main(seed):
    ...
    parser.add_argument('-train_file', default='data/case2_train.json', type=str)
    parser.add_argument('-dev_file', default='data/case2_dev.json', type=str)
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch_idx, data in enumerate(tqdm(train_loader)):
            ...
            if step % args.report_step == 0:
                NDCD30 = evaluate(model, dev_loader, all_labels)
                logger.info('Epoch[{}/{}], loss:{}, NDCG30: {}'.format
                            (epoch + 1, args.num_epochs, loss.item(), NDCD30))
                model.train()
                if best < NDCD30:
                    early_stop = 0
                    best = NDCD30

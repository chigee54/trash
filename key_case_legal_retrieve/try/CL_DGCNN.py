...
def evaluate(model, dataloader, all_labels=None):
    ...
    with torch.no_grad():
        ...
        for data in dataloader:
            ...
            scores, _ = model(x_batch, type='dev')  #
...
def test_result(dataloader, args):
    ...
    with torch.no_grad():
        ...
        for data in tqdm(dataloader):
            ...
            assert len(set(qidx)) == 1
            all_preds[qidx[0]] = pred_ids[:30]
    json.dump(all_preds, open('result/prediction_0.9416_loss5_dropout.json', "w", encoding="utf8"), indent=2,
...
if __name__ == '__main__':
    ...
    dev_extract_npy = './data/phase_2/dev_embeddings_pro.npy'
    train_extract_json = './data/phase_2/train_data_win200.json'
    train_extract_npy = './data/phase_2/train_embeddings_pro.npy'

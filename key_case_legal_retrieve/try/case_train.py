...
def main(seed):
    ...
    parser.add_argument('-train_file', default='data/case_train.json', type=str)
    parser.add_argument('-dev_file', default='data/case_dev.json', type=str)
        ...
        for batch_idx, data in enumerate(tqdm(train_loader)):
            ...
            if step % args.report_step == 0:
                ...
                if early_stop == args.early_stop:
                    logger.info(f"accuracy doesn't improve for {early_stop} batch, early stop!")

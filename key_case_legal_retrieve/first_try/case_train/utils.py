...
def select_relavence(query_file, candidate_dir, stw_file, saved_file, sent_group=6, select=1):
    queries = []
    ...
    for query in tqdm(queries):
        ...
        for doc_file in doc_files:
            ...
            pre_sents = sents_list[:sent_group*2]    # 前12句
...
def doc_segment_selection(data_file, model_path, seg_sel_file):
    ...
    import torch
    from dataset import SegmentSelectionDataset
    from tqdm import tqdm
...
if __name__ == "__main__":
    ...
    query_file = '../data_2021/large/query.json' #'./data/LeCaRD-main/data/query/query.json' #'./data/small/query.json'
    doc_file = '../data_2021/large/candidates/' #'./data/LeCaRD-main/data/candidates/' #'./data/small/candidates/'
    stw_file = './stopword.txt' #'./baseline/stopword.txt'
    saved_file = './data/large_train.json' #'./data/large_train.json' #'./data/small_dev.json'
    # select_relavence(query_file, doc_file, stw_file, saved_file, sent_group=6, select=1)

    data_file = './data/large_train.json'
    label_top30_file = '../data_2021/large/label_top30_dict.json'
    new_data_file = './data/large_train-1.json'
    ...
    data_file = './data/large_train_l.json'
    model_path = '../model/bert/0.9686_law1_model.bin'
    seg_sel_file = './data/large_train_segment_selection_law1.json'

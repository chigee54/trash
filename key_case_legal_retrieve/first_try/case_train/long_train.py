...
def main():
    ...
    parser.add_argument('-train_file', default='data/all_data.json', type=str)
    parser.add_argument('-dev_file', default='data/new_dev.json', type=str)
    ...
    parser.add_argument('-report_step', default=12724, type=int)

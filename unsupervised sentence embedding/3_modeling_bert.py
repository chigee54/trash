    ...
    def forward(
        ...
        if self.training:
            ...
            if not self.config.multi_dropout:
                ...
                embeddings_noise = self.dropout[1](embeddings[2::3].clone())
                embeddings = self.dropout[0](embeddings)
    ...
    def forward(
        ...
        if self.training:
            if not self.config.multi_dropout:
                ...
                attention_noise = self.dropout[1](attention_probs[2::3].clone())
                attention_probs = self.dropout[0](attention_probs)
    ...
    def forward(self, hidden_states, input_tensor):
        ...
        if self.training:
            ...
            if not self.config.multi_dropout:
                ...
                hidden_states_noise = self.dropout[1](hidden_states[2::3].clone())
                hidden_states = self.dropout[0](hidden_states)

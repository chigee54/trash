...
def main(seed):
    ...
    parser.add_argument('-output_path', default='output/try9/{}'.format(seed), type=str)
    ...
    # model = _Custom_Model(args.bert_path, pooling=args.pool_type, pre_seq_len=args.pre_seq_len,
    #                       multi_dropout=args.multi_dropout, dropout_noise=args.dropout_noise,
